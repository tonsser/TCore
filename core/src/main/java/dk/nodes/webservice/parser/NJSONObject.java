 ...
 * Values may be any mix of {@link NJSONObject JSONObjects}, {@link NJSONArray
 ...
 *       coerced, the sentinel value {@link NJSONObject#NULL} is coerced to the
 *       string "null".
 * </ul>
 *
 ...
 * NJSONObject#NULL}. In particular, calling {@code put(name, null)} removes the
...
public class NJSONObject extends JSONObject {
	...
	private String TAG = NJSONObject.class.getName();
	...
	public NJSONObject(Map copyFrom) {
		this();
	 ...
	 *     {@code JSONObject}.
	 */
	public NJSONObject(JSONTokener readFrom) throws JSONException {
		/*
		...
		if (object instanceof NJSONObject) {
			this.nameValuePairs = ((NJSONObject) object).nameValuePairs;
		} else {
			throw NJSON.typeMismatch(object, "JSONObject");
		}
	}
	 ...
	 *     JSONObject}.
	 */
	public NJSONObject(String json) throws JSONException {
	 ...
	 * be skipped.
	 */
	public NJSONObject(NJSONObject copyFrom, String[] names) throws JSONException {
		this();
	 ...
	 * @return this object.
	 */
	public NJSONObject put(String name, boolean value) throws JSONException {
	 ...
	 * @return this object.
	 */
	public NJSONObject put(String name, double value) throws JSONException {
		nameValuePairs.put(checkName(name), NJSON.checkDouble(value));
		return this;
	}
	 ...
	 * @return this object.
	 */
	public NJSONObject put(String name, int value) throws JSONException {
		nameValuePairs.put(checkName(name), value);
		return this;
	}
	 ...
	 * @return this object.
	 */
	public NJSONObject put(String name, long value) throws JSONException {
		nameValuePairs.put(checkName(name), value);
		return this;
	}
	 ...
	 * @return this object.
	 */
	public NJSONObject put(String name, Object value) throws JSONException {
		if (value == null) {
			nameValuePairs.remove(name);
			return this;
		}
		if (value instanceof String) {
			String escapedString = StringEscapeUtils.escapeJson( (String) value );
			nameValuePairs.put(checkName(name), escapedString);
			return this;
		}
	 ...
	 */
	public NJSONObject putOpt(String name, Object value) throws JSONException {
	 ...
	 */
	public NJSONObject accumulate(String name, Object value) throws JSONException {
		...
		if (current instanceof NJSONArray) {
			NJSONArray array = (NJSONArray) current;
			array.put(value);
		} else {
			NJSONArray array = new NJSONArray();
			array.put(current);
			array.put(value);
	...
	public boolean getBoolean(String name) throws JSONException {
		...
		if (result == null) {
			throw NJSON.typeMismatch(name, object, "boolean");
		}
		return result;
	}
	...
	public double getDouble(String name) throws JSONException {
		...
		if (result == null) {
			throw NJSON.typeMismatch(name, object, "double");
		}
		return result;
	}
	...
	public int getInt(String name) throws JSONException {
		...
		if (result == null) {
			throw NJSON.typeMismatch(name, object, "int");
		}
		return result;
	}
	...
	public long getLong(String name) throws JSONException {
		...
		if (result == null) {
			throw NJSON.typeMismatch(name, object, "long");
		}
		return result;
	}
	...
	public String getString(String name) throws JSONException {
		...
		if (result == null) {
			throw NJSON.typeMismatch(name, object, "String");
		}
	 ...
	 *     JSONArray}.
	 */
	public NJSONArray getJSONArray(String name) throws JSONException {
		Object object = get(name);
		if (object instanceof NJSONArray) {
			return (NJSONArray) object;
		} else {
			throw NJSON.typeMismatch(name, object, "JSONArray");
		}
	}

	public NJSONArray getNJSONArray(String name) throws JSONException {
	 ...
	 */
	public NJSONArray optJSONArray(String name) {
		Object object = opt(name);
		return object instanceof NJSONArray ? (NJSONArray) object : null;
	}

	public NJSONArray optNJSONArray(String name) {
	 ...
	 *     JSONObject}.
	 */
	public NJSONObject getJSONObject(String name) throws JSONException {
		Object object = get(name);
		if (object instanceof NJSONObject) {
			return (NJSONObject) object;
		} else {
			throw NJSON.typeMismatch(name, object, "JSONObject");
		}
	}


	public NJSONObject getNJSONObject(String string) throws JSONException {
	 ...
	 */
	public NJSONObject optJSONObject(String name) {
		Object object = opt(name);
		return object instanceof NJSONObject ? (NJSONObject) object : null;
	}

	public NJSONObject optNJSONObject(String name) {
	 ...
	 */
	public NJSONArray toJSONArray(NJSONArray names) throws JSONException {
		NJSONArray result = new NJSONArray();
		if (names == null) {
			return null;
		}
	 ...
	 */
	public NJSONArray names() {
		return nameValuePairs.isEmpty()
				? null
						: new NJSONArray(new ArrayList<String>(nameValuePairs.keySet()));
	}
