...
/**
 * Implements {@link NJSONObject#toString} and {@link NJSONArray#toString}. Most
 ...
 * output. To encode indented output, use {@link NJSONObject#toString(int)} or
 * {@link NJSONArray#toString(int)}.
 *
...
public class JSONStringer {
	...
	private String TAG = JSONStringer.class.getName();
    ...
    public JSONStringer value(Object value) throws JSONException {
        ...
        if (value instanceof NJSONArray) {
            ((NJSONArray) value).writeTo(this);
            return this;

        } else if (value instanceof NJSONObject) {
            ((NJSONObject) value).writeTo(this);
            return this;
        }
        ...
        if (value == null
                ...
                || value == NJSONObject.NULL) {
            out.append(value);

        } else if (value instanceof Number) {
            out.append(NJSONObject.numberToString((Number) value));

        } else {
        	string( StringEscapeUtils.unescapeJava( value.toString() ));
        }
    ...
    public JSONStringer value(double value) throws JSONException {
        ...
        beforeValue();
        out.append(NJSONObject.numberToString(value));
        return this;
    }
