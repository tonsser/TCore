...
import dk.tonsser.utils.TAndroidIntents;
...
public class RateMeDialog extends Dialog {
     ...
     */
    public RateMeDialog(final Context mContext, String infoText, String yesText, String AskMeLaterText, String noText, final SharedPreferences.Editor editor, String packageName, String appName) {
        super(mContext);
        ...
        rateItButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TAndroidIntents.toMarket(mContext);
                dialog.dismiss();
            }
        });
