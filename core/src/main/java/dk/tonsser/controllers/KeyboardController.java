...
public class KeyboardController {
    ...
    public static boolean isKeyboardShowing(final Activity activity) {
        ...
        try {
            ...
            return heightDiff > ScreenParameters.toPx(100);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
     ...
     * @param contentView
     * @param editText
     * @param cancelable  This makes the user able to cancel (hide) the keyboard when touching the screen outside the EditText.
            ...
            if (cancelable) {
                et.setOnFocusChangeListener(new OnFocusChangeListener() {
                    ...
                    public void onFocusChange(View v, boolean hasFocus) {
                        KeyboardController.showKeyboard(activity, et, hasFocus);
                    }
                });
            } else {
     ...
     *                 <p/>
     *                 This can be used with an OnFocusChangeListener on an EditText for the same functionality as KeyboardController.setCancelable() for lots of win:
     *                 <p/>
     *                 inputEt.setOnFocusChangeListener(new OnFocusChangeListener() {
     * @Override public void onFocusChange(View v, boolean hasFocus) {
     * KeyboardController.showKeyboard(SomeActivity.this, inputEt, hasFocus);
     * }
     * });
     * <p/>
    ...
    public static void showKeyboardDelayed(final Activity mActivity, final EditText editText, int delayMs) {
        TUtils.performTaskDelayWithCallbackInMainThread(mActivity, delayMs, new TUtils.NCallbackListener() {
