...
public class TagHandler implements Html.TagHandler {
    ...
    public void handleTag(boolean opening, String tag, Editable output, XMLReader xmlReader) {
        if (tag.equalsIgnoreCase("ul")) {
            ...
            if (opening) {
                ...
                output.setSpan(new ClickableSpan() {
                    ...
                    public void onClick(View widget) {
                        if (TBaseApplication.getInstance() != null && mURLSpan != null)
                            TAndroidIntents.toBrowser(TBaseApplication.getInstance(), mURLSpan.getURL());
                    }
            ...
            if (opening) TLog.d(TagHandler.class.getName(), "Found an unsupported tag " + tag);
        }
    }
