...
public class TRunningService extends Service {
    ...
    private void startAlarms() {
        ...
        Intent alarm = new Intent(this, NotificationAlarmReceiver.class);
        ...
        TLog.d("RunningService startAlarms", "Next Alarm is: " + calendar.getTime().toString());
