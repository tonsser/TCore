...
import dk.tonsser.controllers.web.NTagHandler;
...
public class NAndroidIntents {
    ...
    public static void callNumberAfterConfirmation(final Activity mActivity, final String phoneNumbe,
        ...
        new NBasicAlertDialog(mActivity, null, question, no, yes, true, new NBasicAlertDialog.NBasicAlertDialogListener() {
