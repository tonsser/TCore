package dk.tonsser.widgets.textviews;
 ...
 */
public class NAutoResizeTextView extends TextView {

    private static final String TAG = NAutoResizeTextView.class.getName();
    private static final boolean SPEW = false;

    // Minimum size of the text in pixels
    private static final int DEFAULT_MIN_TEXT_SIZE = NScreenParameters.toPx(16); //px
    ...
    public NAutoResizeTextView(Context context) {
        super(context);
        init();
    }

    public NAutoResizeTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
