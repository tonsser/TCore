package dk.tonsser.widgets.buttons;
...
public class TProgressButton extends FrameLayout {
    ...
    public TProgressButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public TProgressButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
