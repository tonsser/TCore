package com.tonsser.sensor.compassview.calculations;


public class NCompassMatrix {
    private static final NCompassVector worldUp = new NCompassVector(0, 1, 0);
    private static final NCompassVector dir = new NCompassVector();
    private static final NCompassVector right = new NCompassVector();
    private static final NCompassVector up = new NCompassVector();
    private static final NCompassMatrix tmp = new NCompassMatrix();
    ...
    public NCompassMatrix() {
    }

    public NCompassMatrix(NCompassMatrix m) {
     ...
     * array[3] = b1, array[4] = b2, array[5] = b3
     * array[6] = c1, array[7] = c2, array[8] = c3
     *
     ...
     */
    public void set(NCompassMatrix m) {
        if (m == null) throw new NullPointerException();
    ...
    /**
     * Resets this to a clean identity matrix
     */
    ...
    public void toAt(NCompassVector cam, NCompassVector obj) {
    ...
    public synchronized void add(NCompassMatrix n) {
    ...
    public synchronized void prod(NCompassMatrix n) {
        if (n == null) throw new NullPointerException();
    ...
    public synchronized boolean equals(NCompassMatrix n) {
