package com.tonsser.widgets.textviews;
 ...
 */
public class TAutoResizeTextView extends TextView {

    private static final String TAG = TAutoResizeTextView.class.getName();
    private static final boolean SPEW = false;

    // Minimum size of the text in pixels
    private static final int DEFAULT_MIN_TEXT_SIZE = ScreenParameters.toPx(16); //px
    ...
    public TAutoResizeTextView(Context context) {
        super(context);
        init();
    }

    public TAutoResizeTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
